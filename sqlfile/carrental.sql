...
(1, 'admin', '5c428d8875d2948607f3e3fe134d71b4', '2020-01-18 13:22:38'),
(3, 'Sebastian', '123', '2020-04-01 14:46:56');

-- --------------------------------------------------------

--
-- Table structure for table `logsbrands`
--

CREATE TABLE `logsbrands` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `logsbrands`
--

INSERT INTO `logsbrands` (`id`, `brand_id`, `action`, `cdate`) VALUES
(1, 14, 'Inserted', '2020-04-18 12:23:01'),
(2, 15, 'Inserted', '2020-04-18 12:33:11');

-- --------------------------------------------------------

--
-- Table structure for table `logsvehicles`
--

CREATE TABLE `logsvehicles` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `logsvehicles`
--
...
(1, 'test@gmail.com', 2, '22/5/2019', '25/05/2019', 'First test', 1, '2019-05-19 20:15:43'),
(2, 'test@gmail.com', 3, '30/02/2020', '02/02/2020', 'Second test', 2, '2020-02-26 21:15:43'),
(3, 'test@gmail.com', 4, '02/02/2020', '07/02/2020', 'Third test', 0, '2020-02-26 22:10:06');
...
(1, 'Maruti', '2020-01-18 17:24:34'),
(2, 'BMW', '2020-01-18 17:24:50'),
(3, 'Audi', '2020-01-18 17:25:03'),
(4, 'Nissan', '2020-01-18 17:25:13'),
(5, 'Toyota', '2020-01-18 17:25:24'),
(7, 'Marutiu', '2020-01-19 07:22:13'),
(8, 'BMW', '2020-01-17 11:44:39'),
(14, 'dasdasdasd', '2020-04-18 09:22:55'),
(15, 'Brand1', '2020-04-18 09:33:01');

--
-- Triggers `tblbrands`
--
DELIMITER $$
CREATE TRIGGER `logsbrands` AFTER INSERT ON `tblbrands` FOR EACH ROW INSERT INTO logsbrands VALUES(NULL,NEW.id,'Inserted',NOW())
$$
DELIMITER ;
...
(1, 'First Person', 'something@yahoo.com', '2147483647', 'First Person', '2020-02-18 11:03:07', 1);
...
(2, 'Privacy Policy', 'privacy', '<span style=\"color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; font-size: 14px; text-align: justify;\">Don t use to much this website.Enjoy!</span>'),
(3, 'About Us ', 'aboutus', '<span style=\"color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; text-align: justify;\">Hy there, my name is Galbinita Sebastian , thi s is one of my projects in PHP\\MySql. I hope you enjoy the website :).This message is from a database in tblpages section.</span>'),
...
(1, 'anuj.lpu1@gmail.com', '2020-03-22 17:35:32'),
(4, 'lozag0@yahoo.com', '2020-04-18 08:00:34');
...
(1, 'test@gmail.com', 'Test Test', '2020-03-18 08:44:31', 1),
(2, 'test@gmail.com', 'something', '2020-03-18 08:46:05', 0),
(3, 'lozag0@yahoo.com', 'This is my first testimonial', '2020-04-17 15:05:44', NULL);
...
--
-- Indexes for table `logsbrands`
--
ALTER TABLE `logsbrands`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `logsvehicles`
--
...
--
-- AUTO_INCREMENT for table `logsbrands`
--
ALTER TABLE `logsbrands`
